...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className=" p-2 md:mycontainer min-h-[84.1vh] ">
                ...
                <p className='text-green-900 text-lg text-center'>Manage your passwords in a secure way</p>
                ...
                <div className='flex flex-col p-4 text-black gap-8 items-center'>
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        ...
                        <div className="relative">
                            ...
                            <span className='absolute right-[-10px] top-[2px] cursor-pointer' onClick={showPassword}>
                                <img ref={ref} className='p-1' width={60} src='icons/Eye Show.png' alt='eye' />
                            </span>
                        </div>
                    </div>


                    <button onClick={savePassword} className='flex justify-center gap-2 items-center bg-green-300 hover:bg-green-500 rounded-full px-8 py-2 w-fit border border-green-700'>
                        <lord-icon
                                    ...
                                    <td className='py-2 border border-white text-center'>
                                        <div className='flex items-center justify-center'>
                                            ...
                                            <div className='lordiconcopy size-7 cursor-pointer' onClick={() => { copyText(item.site) }}>
                                                {/* <div className='lordiconcopy lordiconcopy size-7 cursor-pointer' onClick={() => { copyText(item.site) }}> */}
                                                <lord-icon
